...
def main():
    ...
    savings_interest = float(input("Enter the annual interest rate for the savings account (as %): "))
    ...
    cd_interest = float(input("Enter the annual interest rate for the CD account (as %): "))
